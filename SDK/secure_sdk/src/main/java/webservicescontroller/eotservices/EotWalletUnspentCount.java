 ...
 * with VVDN.
 ********************************************************************/
public class EotWalletUnspentCount {
    /**
     * Debugging variable of this class
     */
    private String TAG = EotWalletUnspentCount.class.getSimpleName();
    /**
    ...
    public EotWalletUnspentCount(WalletUnspentCountHandler mWalletUnspentCountHandler) {
    ...
    public void checkMyWallet(String wallet_address) {
        ...
        JsonArrayRequest jsonObjReq = new JsonArrayRequest(Request.Method.GET, mWalletAPIUrl,
            ...
            public void onResponse(JSONArray mUncountCoinsResponse) {
                try {
                    SDKUtils.showLog(TAG, "--------Unspent Count-----" + mUncountCoinsResponse);
            ...
            public void onErrorResponse(VolleyError volleyError) {
                SDKUtils.showLog(TAG, "-------Utxo Error----" + volleyError);
                if (mWalletUnspentCountHandler != null)
    ...
    private String getServerUrl(String wallet_address) {
        ...
        mInsightUrl = "http://178.62.30.50:3622/api/addr/" + wallet_address + SDKHelper.INSIGHT_TO;
        return mInsightUrl;
    }
}
