 ...
 * with VVDN.
 ********************************************************************/
public class EOTCoinTransactionBroadcast {
    /**
     * This class variable is used to keep the debugging track of this class
     */
    private String TAG = EOTCoinTransactionBroadcast.class.getSimpleName();
    /**
     ...
     */
    public EOTCoinTransactionBroadcast(BroadcastBitCoinTransactionHandler mBroadcastBitCoinTransactionHandler) {
     ...
     * @param mTransaction
     */
    public void broadCastTransaction(final String mTransaction) {
        try {
        ...
        SDKUtils.showLog(TAG, "----Transaction Publishing-----" + mJsonRequest);
        mTransactionHistoryUrl = SDKHelper.EOT_TX_BROADCAST_URL;
