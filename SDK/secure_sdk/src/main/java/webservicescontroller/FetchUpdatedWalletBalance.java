 ...
 ********************************************************************/
public class FetchUpdatedWalletBalance {
    /**
     * Debugging variable of this class
     */
    private String TAG = FetchUpdatedWalletBalance.class.getSimpleName();
    /**
    ...
    public FetchUpdatedWalletBalance(WalletBalanceCallback mWalletBalanceCallback) {
     ...
     * @param wallet_id
     */
    public void checkWalletForUpdateBalance(String wallet_address, int wallet_id) {
    ...
    private String getServerUrl(String wallet_address) {
        ...
        if (SDKConstants.WALLET_TYPE == SDKHelper.ZERO)
            ...
            mInsightUrl = SDKHelper.EOT_TRANSACTION_HISTORY_URL + wallet_address + SDKHelper.INSIGHT_TO;
        return mInsightUrl;
    }
}
